...
accumulate(int total, int value) {
	printf("accumulate totalIn %d and value%d\n",total,value);    
...
test_twisted_sum_array() {
    ...
    int odd_array[] = {0,1,3,3,7,40833,2041665,128624895,128624895,9,408292,-436220288,-436220286,128624899,10,408290 ,-436220296 ,771749400, 128624900 ,4500 ,408248, 408240, 45360, 4536, 4525};
    printf("twisted_sum_array(odd_array, 25) is: %d\n",
           twisted_sum_array(odd_array, 25));
}
