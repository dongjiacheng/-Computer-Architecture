...
module mips_decode(alu_op, writeenable, rd_src, alu_src2, except, control_type,
    ...
    assign writeenable = inst_add | inst_addi |  inst_sub | inst_and | inst_or | inst_xor | inst_ori | inst_andi | inst_xori | inst_nor | inst_lui | inst_slt | inst_lw | inst_lbu | inst_addm;
    assign except = ~(inst_add | inst_addi |  inst_sub | inst_and | inst_or | inst_xor | inst_ori | inst_andi | inst_xori | inst_nor | inst_lui | inst_slt | inst_lw | inst_lbu | inst_sw | inst_sb | inst_beq | inst_bne | inst_j | inst_jr | inst_addm);
    
    or oA1(alu_op[0],inst_sub,inst_or,inst_xor,inst_ori,inst_xori,inst_beq,inst_bne,inst_slt);
    or oA2(alu_op[1],inst_add,inst_sub,inst_nor,inst_xor,inst_addi,inst_xori,inst_beq,inst_bne,inst_slt,inst_lw,inst_lbu,inst_sw,inst_sb,inst_addm);
