module mips_decode(NEW ,ALUOp, RegWrite, BEQ, ALUSrc, MemRead, MemWrite, MemToReg, RegDst, 
                   opcode, funct,Mod);

   output [2:0] ALUOp;
   output       RegWrite, BEQ, ALUSrc, MemRead, MemWrite, MemToReg, RegDst,NEW;
...
module machine(clk, reset);
   ...
   wire [31:0]  PC;
   wire [31:2]  next_PC, PC_plus4, PC_target,next_PC1;
   wire [31:0]  inst;
   ...
   wire         RegWrite, BEQ, ALUSrc, MemRead, MemWrite, MemToReg, RegDst,Mod,NEW;
   ...
   mux2v #(30) branch_mux1(next_PC, next_PC1, rd1_data[31:2], NEW);
   assign PCSrc = BEQ & zero;
      
   instruction_memory imem (inst, PC[31:2]);

   assign Mod = rd1_data[1:0] == 2'b00;

   mips_decode decode(NEW,ALUOp, RegWrite, BEQ, ALUSrc, MemRead, MemWrite, MemToReg, RegDst, 
                      opcode, funct,Mod);
