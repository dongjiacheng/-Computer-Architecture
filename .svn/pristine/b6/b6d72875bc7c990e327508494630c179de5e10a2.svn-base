...
module dffe(q, d, clk, enable, reset);
    ...
    assign in00 = bits == 3'b000;
    assign in11 = bits == 3'b111;

    assign sGarbage_next = ((sBlank | sI_end) & ~(in00 | in11)) | ((sI | sGarbage) & ~in00)|restart;
    assign sBlank_next = (sBlank | sI_end | sGarbage) & in00 & ~restart;
